...
public class GrafanaAPI extends CommonOps {
    ...
    public void test01_verifyTeam() {
        Verifications.verifyText(ApiFlows.getTeamProperty("teams[0].name"), "Bitcoin");
    }
    ...
    public void test02_addTeamAndVerify() {
        ApiFlows.postTeam("Cardano", "cardano@ada.com");
        Verifications.verifyText(ApiFlows.getTeamProperty("teams[1].name"), "Cardano");
    ...
    public void test03_updateTeamAndVerify() {
        ...
        ApiFlows.updateTeam("Cardano", "cardano@ada.com", id);
        Verifications.verifyText(ApiFlows.getTeamProperty("teams[1].email"), "cardano@ada.com");
